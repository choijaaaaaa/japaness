...
const VOCAB = [
  ...
  { level: "N5", kanji: "いってきます", reading: "いってきます", korean: "잇테키마스", meaning: "다녀오겠습니다",
    example: "毎朝いってきますと言います。", exampleReading: "まいあさいってきますといいます。", exampleKorean: "마이아사 잇테키마스토 이이마스", exampleMeaning: "매일 아침 다녀오겠습니다라고 말합니다.",
    breakdown: [
      { word: "毎朝", reading: "まいあさ", meaning: "매일 아침" }
    ] },
  { level: "N5", kanji: "いってらっしゃい", reading: "いってらっしゃい", korean: "잇테랏샤이", meaning: "다녀오세요",
    example: "母がいってらっしゃいと言いました。", exampleReading: "ははがいってらっしゃいといいました。", exampleKorean: "하하가 잇테랏샤이토 이이마시타", exampleMeaning: "엄마가 다녀오세요라고 말했습니다.",
    breakdown: [
      { word: "母", reading: "はは", meaning: "엄마" }
    ] },
  { level: "N5", kanji: "ただいま", reading: "ただいま", korean: "타다이마", meaning: "다녀왔습니다",
    example: "家に着いてただいまと言いました。", exampleReading: "いえについてただいまといいました。", exampleKorean: "이에니 츠이테 타다이마토 이이마시타", exampleMeaning: "집에 도착해서 다녀왔습니다라고 말했습니다.",
    breakdown: [
      { word: "家に着いて", reading: "いえについて", meaning: "집에 도착해서" }
    ] },
  { level: "N5", kanji: "おかえりなさい", reading: "おかえりなさい", korean: "오카에리나사이", meaning: "어서 오세요(귀가)",
    example: "家族がおかえりなさいと迎えてくれました。", exampleReading: "かぞくがおかえりなさいとむかえてくれました。", exampleKorean: "카조쿠가 오카에리나사이토 무카에테 쿠레마시타", exampleMeaning: "가족이 어서 오세요라며 맞아 주었습니다.",
    breakdown: [
      { word: "家族", reading: "かぞく", meaning: "가족" }
    ] },
  { level: "N5", kanji: "お邪魔します", reading: "おじゃまします", korean: "오자마시마스", meaning: "실례하겠습니다(방문)",
    example: "友達の家でお邪魔しますと言いました。", exampleReading: "ともだちのいえでおじゃまますといいました。", exampleKorean: "토모다치노 이에데 오자마시마스토 이이마시타", exampleMeaning: "친구 집에서 실례하겠습니다라고 말했습니다.",
    breakdown: [
      { word: "友達の家", reading: "ともだちのいえ", meaning: "친구 집" }
    ] },
  { level: "N5", kanji: "失礼します", reading: "しつれいします", korean: "시츠레-시마스", meaning: "실례합니다",
    example: "部屋に入る前に失礼しますと言いました。", exampleReading: "へやにはいるまえにしつれいしますといいました。", exampleKorean: "헤야니 하이루 마에니 시츠레-시마스토 이이마시타", exampleMeaning: "방에 들어가기 전에 실례합니다라고 말했습니다.",
    breakdown: [
      { word: "部屋", reading: "へや", meaning: "방" }
    ] },
  { level: "N5", kanji: "お疲れ様です", reading: "おつかれさまです", korean: "오츠카레사마데스", meaning: "수고하십니다",
    example: "会社の同僚にお疲れ様ですと言いました。", exampleReading: "かいしゃのどうりょうにおつかれさまですといいました。", exampleKorean: "카이샤노 도-료-니 오츠카레사마데스토 이이마시타", exampleMeaning: "회사 동료에게 수고하십니다라고 말했습니다.",
    breakdown: [
      { word: "同僚", reading: "どうりょう", meaning: "동료" }
    ] },
  { level: "N5", kanji: "お世話になります", reading: "おせわになります", korean: "오세와니나리마스", meaning: "신세 지겠습니다",
    example: "これからお世話になりますと挨拶しました。", exampleReading: "これからおせわになりますとあいさつしました。", exampleKorean: "코레카라 오세와니나리마스토 아이사츠 시마시타", exampleMeaning: "앞으로 신세 지겠습니다라고 인사했습니다.",
    breakdown: [
      { word: "これから", reading: "これから", meaning: "앞으로" }
    ] },
  { level: "N5", kanji: "気を付けて", reading: "きをつけて", korean: "키오츠케테", meaning: "조심해",
    example: "車に気を付けてと言われました。", exampleReading: "くるまにきをつけてといわれました。", exampleKorean: "쿠루마니 키오츠케테토 이와레마시타", exampleMeaning: "차 조심하라는 말을 들었습니다.",
    breakdown: [
      { word: "車", reading: "くるま", meaning: "차" }
    ] },
  { level: "N5", kanji: "お大事に", reading: "おだいじに", korean: "오다이지니", meaning: "몸조리 잘하세요",
    example: "医者にお大事にと言われました。", exampleReading: "いしゃにおだいじにといわれました。", exampleKorean: "이샤니 오다이지니토 이와레마시타", exampleMeaning: "의사에게 몸조리 잘하시라는 말을 들었습니다.",
    breakdown: [
      { word: "医者", reading: "いしゃ", meaning: "의사" }
    ] },
  { level: "N5", kanji: "梅雨", reading: "つゆ", korean: "츠유", meaning: "장마",
    example: "日本には梅雨があります。", exampleReading: "にほんにはつゆがあります。", exampleKorean: "니혼니와 츠유가 아리마스", exampleMeaning: "일본에는 장마가 있습니다.",
    breakdown: [
      { word: "日本", reading: "にほん", meaning: "일본" }
    ] },
  { level: "N5", kanji: "猛暑", reading: "もうしょ", korean: "모-쇼", meaning: "폭염",
    example: "今年の夏は猛暑です。", exampleReading: "ことしのなつはもうしょです。", exampleKorean: "코토시노 나츠와 모-쇼데스", exampleMeaning: "올해 여름은 폭염입니다.",
    breakdown: [
      { word: "今年", reading: "ことし", meaning: "올해" }
    ] },
  { level: "N5", kanji: "蒸し暑い", reading: "むしあつい", korean: "무시아츠이", meaning: "무덥다",
    example: "今日は蒸し暑いですね。", exampleReading: "きょうはむしあついですね。", exampleKorean: "쿄-와 무시아츠이데스네", exampleMeaning: "오늘은 무덥네요.",
    breakdown: [
      { word: "今日", reading: "きょう", meaning: "오늘" }
    ] },
  { level: "N5", kanji: "肌寒い", reading: "はだざむい", korean: "하다자무이", meaning: "쌀쌀하다",
    example: "朝晩は肌寒いです。", exampleReading: "あさばんははだざむいです。", exampleKorean: "아사반와 하다자무이데스", exampleMeaning: "아침저녁으로 쌀쌀합니다.",
    breakdown: [
      { word: "朝晩", reading: "あさばん", meaning: "아침저녁" }
    ] },
  { level: "N5", kanji: "冷え込む", reading: "ひえこむ", korean: "히에코무", meaning: "급격히 추워지다",
    example: "今夜は冷え込むそうです。", exampleReading: "こんやはひえこむそうです。", exampleKorean: "콘야와 히에코무 소-데스", exampleMeaning: "오늘 밤은 급격히 추워진다고 합니다.",
    breakdown: [
      { word: "今夜", reading: "こんや", meaning: "오늘 밤" }
    ] },
  { level: "N5", kanji: "天気予報", reading: "てんきよほう", korean: "텐키요호-", meaning: "일기예보",
    example: "天気予報を見ました。", exampleReading: "てんきよほうをみました。", exampleKorean: "텐키요호-오 미마시타", exampleMeaning: "일기예보를 봤습니다.",
    breakdown: [
      { word: "見ました", reading: "みました", meaning: "봤습니다" }
    ] },
  { level: "N5", kanji: "積雪", reading: "せきせつ", korean: "세키세츠", meaning: "적설",
    example: "積雪が多い地域です。", exampleReading: "せきせつがおおいちいきです。", exampleKorean: "세키세츠가 오-이 치이키데스", exampleMeaning: "적설이 많은 지역입니다.",
    breakdown: [
      { word: "地域", reading: "ちいき", meaning: "지역" }
    ] },
  { level: "N5", kanji: "雷", reading: "かみなり", korean: "카미나리", meaning: "천둥",
    example: "昨夜、雷が鳴りました。", exampleReading: "さくや、かみなりがなりました。", exampleKorean: "사쿠야, 카미나리가 나리마시타", exampleMeaning: "어젯밤 천둥이 쳤습니다.",
    breakdown: [
      { word: "昨夜", reading: "さくや", meaning: "어젯밤" }
    ] },
  { level: "N5", kanji: "稲妻", reading: "いなずま", korean: "이나즈마", meaning: "번개",
    example: "稲妻が光りました。", exampleReading: "いなずまがひかりました。", exampleKorean: "이나즈마가 히카리마시타", exampleMeaning: "번개가 번쩍였습니다.",
    breakdown: [
      { word: "光りました", reading: "ひかりました", meaning: "번쩍였습니다" }
    ] },
  { level: "N5", kanji: "霧", reading: "きり", korean: "키리", meaning: "안개",
    example: "朝は霧が濃かったです。", exampleReading: "あさはきりがこかったです。", exampleKorean: "아사와 키리가 코캇타데스", exampleMeaning: "아침에는 안개가 짙었습니다.",
    breakdown: [
      { word: "濃かった", reading: "こかった", meaning: "짙었다" }
    ] },
  { level: "N5", kanji: "露", reading: "つゆ", korean: "츠유", meaning: "이슬",
    example: "草に露がついています。", exampleReading: "くさにつゆがついています。", exampleKorean: "쿠사니 츠유가 츠이테 이마스", exampleMeaning: "풀에 이슬이 맺혀 있습니다.",
    breakdown: [
      { word: "草", reading: "くさ", meaning: "풀" }
    ] },
  { level: "N5", kanji: "朝露", reading: "あさつゆ", korean: "아사츠유", meaning: "아침이슬",
    example: "朝露で靴が濡れました。", exampleReading: "あさつゆでくつがぬれました。", exampleKorean: "아사츠유데 쿠츠가 누레마시타", exampleMeaning: "아침이슬로 신발이 젖었습니다.",
    breakdown: [
      { word: "靴", reading: "くつ", meaning: "신발" }
    ] },
  { level: "N5", kanji: "夕立", reading: "ゆうだち", korean: "유-다치", meaning: "소나기",
    example: "夕立に降られました。", exampleReading: "ゆうだちにふられました。", exampleKorean: "유-다치니 후라레마시타", exampleMeaning: "소나기를 맞았습니다.",
    breakdown: [
      { word: "降られました", reading: "ふられました", meaning: "맞았습니다" }
    ] },
  { level: "N5", kanji: "にわか雨", reading: "にわかあめ", korean: "니와카아메", meaning: "소나기",
    example: "にわか雨が降ってきました。", exampleReading: "にわかあめがふってきました。", exampleKorean: "니와카아메가 훗테 키마시타", exampleMeaning: "소나기가 내리기 시작했습니다.",
    breakdown: [
      { word: "降ってきました", reading: "ふってきました", meaning: "내리기 시작했습니다" }
    ] },
  { level: "N5", kanji: "快晴", reading: "かいせい", korean: "카이세-", meaning: "쾌청",
    example: "今日は快晴です。", exampleReading: "きょうはかいせいです。", exampleKorean: "쿄-와 카이세-데스", exampleMeaning: "오늘은 쾌청합니다.",
    breakdown: [
      { word: "今日", reading: "きょう", meaning: "오늘" }
    ] },
  { level: "N5", kanji: "曇天", reading: "どんてん", korean: "돈텐", meaning: "흐린 하늘",
    example: "曇天が続いています。", exampleReading: "どんてんがつづいています。", exampleKorean: "돈텐가 츠즈이테 이마스", exampleMeaning: "흐린 날씨가 계속되고 있습니다.",
    breakdown: [
      { word: "続いて", reading: "つづいて", meaning: "계속되어" }
    ] },
  { level: "N5", kanji: "突風", reading: "とっぷう", korean: "톳푸-", meaning: "돌풍",
    example: "突風が吹きました。", exampleReading: "とっぷうがふきました。", exampleKorean: "톳푸-가 후키마시타", exampleMeaning: "돌풍이 불었습니다.",
    breakdown: [
      { word: "吹きました", reading: "ふきました", meaning: "불었습니다" }
    ] },
  { level: "N5", kanji: "強風", reading: "きょうふう", korean: "쿄-후-", meaning: "강풍",
    example: "強風に注意してください。", exampleReading: "きょうふうにちゅういしてください。", exampleKorean: "쿄-후-니 츄-이 시테 쿠다사이", exampleMeaning: "강풍에 주의해 주세요.",
    breakdown: [
      { word: "注意", reading: "ちゅうい", meaning: "주의" }
    ] },
  { level: "N5", kanji: "微風", reading: "びふう", korean: "비후-", meaning: "산들바람",
    example: "微風が心地よいです。", exampleReading: "びふうがここちよいです。", exampleKorean: "비후-가 코코치요이데스", exampleMeaning: "산들바람이 기분 좋습니다.",
    breakdown: [
      { word: "心地よい", reading: "ここちよい", meaning: "기분 좋다" }
    ] },
  { level: "N5", kanji: "虹色", reading: "にじいろ", korean: "니지이로", meaning: "무지개색",
    example: "虹色に光っています。", exampleReading: "にじいろにひかっています。", exampleKorean: "니지이로니 히캇테 이마스", exampleMeaning: "무지개색으로 빛나고 있습니다.",
    breakdown: [
      { word: "光って", reading: "ひかって", meaning: "빛나서" }
    ] },
  { level: "N5", kanji: "花見", reading: "はなみ", korean: "하나미", meaning: "꽃구경",
    example: "春に花見をしました。", exampleReading: "はるにはなみをしました。", exampleKorean: "하루니 하나미오 시마시타", exampleMeaning: "봄에 꽃구경을 했습니다.",
    breakdown: [
      { word: "春", reading: "はる", meaning: "봄" }
    ] },
  { level: "N5", kanji: "紅葉狩り", reading: "もみじがり", korean: "모미지가리", meaning: "단풍놀이",
    example: "秋に紅葉狩りに行きました。", exampleReading: "あきにもみじがりにいきました。", exampleKorean: "아키니 모미지가리니 이키마시타", exampleMeaning: "가을에 단풍놀이를 갔습니다.",
    breakdown: [
      { word: "秋", reading: "あき", meaning: "가을" }
    ] },
  { level: "N5", kanji: "雪だるま", reading: "ゆきだるま", korean: "유키다루마", meaning: "눈사람",
    example: "雪だるまを作りました。", exampleReading: "ゆきだるまをつくりました。", exampleKorean: "유키다루마오 츠쿠리마시타", exampleMeaning: "눈사람을 만들었습니다.",
    breakdown: [
      { word: "作りました", reading: "つくりました", meaning: "만들었습니다" }
    ] },
  { level: "N5", kanji: "雪合戦", reading: "ゆきがっせん", korean: "유키갓센", meaning: "눈싸움",
    example: "子供と雪合戦をしました。", exampleReading: "こどもとゆきがっせんをしました。", exampleKorean: "코도모토 유키갓센오 시마시타", exampleMeaning: "아이와 눈싸움을 했습니다.",
    breakdown: [
      { word: "子供と", reading: "こどもと", meaning: "아이와" }
    ] },
  { level: "N5", kanji: "初詣", reading: "はつもうで", korean: "하츠모-데", meaning: "새해 첫 참배",
    example: "元日に初詣に行きました。", exampleReading: "がんじつにはつもうでにいきました。", exampleKorean: "간지츠니 하츠모-데니 이키마시타", exampleMeaning: "설날에 새해 첫 참배를 갔습니다.",
    breakdown: [
      { word: "元日", reading: "がんじつ", meaning: "설날" }
    ] },
  { level: "N5", kanji: "年越しそば", reading: "としこしそば", korean: "토시코시소바", meaning: "해넘이 소바",
    example: "大晦日に年越しそばを食べました。", exampleReading: "おおみそかにとしこしそばをたべました。", exampleKorean: "오-미소카니 토시코시소바오 타베마시타", exampleMeaning: "섣달그믐에 해넘이 소바를 먹었습니다.",
    breakdown: [
      { word: "大晦日", reading: "おおみそか", meaning: "섣달그믐" }
    ] },
  { level: "N5", kanji: "お正月", reading: "おしょうがつ", korean: "오쇼-가츠", meaning: "설날",
    example: "お正月に家族で集まりました。", exampleReading: "おしょうがつにかぞくであつまりました。", exampleKorean: "오쇼-가츠니 카조쿠데 아츠마리마시타", exampleMeaning: "설날에 가족이 모였습니다.",
    breakdown: [
      { word: "家族", reading: "かぞく", meaning: "가족" }
    ] },
  { level: "N5", kanji: "お盆", reading: "おぼん", korean: "오본", meaning: "오봉(추석)",
    example: "お盆に実家に帰りました。", exampleReading: "おぼんにじっかにかえりました。", exampleKorean: "오본니 짓카니 카에리마시타", exampleMeaning: "오봉(추석)에 본가에 갔습니다.",
    breakdown: [
      { word: "実家", reading: "じっか", meaning: "본가" }
    ] },
  { level: "N5", kanji: "クリスマス", reading: "クリスマス", korean: "쿠리스마스", meaning: "크리스마스",
    example: "クリスマスにケーキを食べました。", exampleReading: "クリスマスにケーキをたべました。", exampleKorean: "쿠리스마스니 케-키오 타베마시타", exampleMeaning: "크리스마스에 케이크를 먹었습니다.",
    breakdown: [
      { word: "ケーキ", reading: "ケーキ", meaning: "케이크" }
    ] },
  { level: "N5", kanji: "バレンタインデー", reading: "バレンタインデー", korean: "바렌타인데-", meaning: "밸런타인데이",
    example: "バレンタインデーにチョコをあげました。", exampleReading: "バレンタインデーにチョコをあげました。", exampleKorean: "바렌타인데-니 쵸코오 아게마시타", exampleMeaning: "밸런타인데이에 초콜릿을 줬습니다.",
    breakdown: [
      { word: "チョコ", reading: "チョコ", meaning: "초콜릿" }
    ] },
  { level: "N5", kanji: "ハロウィン", reading: "ハロウィン", korean: "하로윈", meaning: "할로윈",
    example: "ハロウィンの仮装をしました。", exampleReading: "ハロウィンのかそうをしました。", exampleKorean: "하로윈노 카소-오 시마시타", exampleMeaning: "할로윈 분장을 했습니다.",
    breakdown: [
      { word: "仮装", reading: "かそう", meaning: "분장" }
    ] },
  { level: "N5", kanji: "誕生日プレゼント", reading: "たんじょうびプレゼント", korean: "탄죠-비 푸레젠토", meaning: "생일 선물",
    example: "誕生日プレゼントをもらいました。", exampleReading: "たんじょうびプレゼントをもらいました。", exampleKorean: "탄죠-비 푸레젠토오 모라이마시타", exampleMeaning: "생일 선물을 받았습니다.",
    breakdown: [
      { word: "もらいました", reading: "もらいました", meaning: "받았습니다" }
    ] },
  { level: "N5", kanji: "結婚祝い", reading: "けっこんいわい", korean: "켁콘이와이", meaning: "결혼 축하선물",
    example: "結婚祝いを贈りました。", exampleReading: "けっこんいわいをおくりました。", exampleKorean: "켁콘이와이오 오쿠리마시타", exampleMeaning: "결혼 축하선물을 보냈습니다.",
    breakdown: [
      { word: "贈りました", reading: "おくりました", meaning: "보냈습니다" }
    ] },
  { level: "N5", kanji: "出産祝い", reading: "しゅっさんいわい", korean: "슛산이와이", meaning: "출산 축하선물",
    example: "出産祝いを渡しました。", exampleReading: "しゅっさんいわいをわたしました。", exampleKorean: "슛산이와이오 와타시마시타", exampleMeaning: "출산 축하선물을 건넸습니다.",
    breakdown: [
      { word: "渡しました", reading: "わたしました", meaning: "건넸습니다" }
    ] },
  { level: "N5", kanji: "お年玉", reading: "おとしだま", korean: "오토시다마", meaning: "세뱃돈",
    example: "子供にお年玉をあげました。", exampleReading: "こどもにおとしだまをあげました。", exampleKorean: "코도모니 오토시다마오 아게마시타", exampleMeaning: "아이에게 세뱃돈을 줬습니다.",
    breakdown: [
      { word: "子供に", reading: "こどもに", meaning: "아이에게" }
    ] },
  { level: "N5", kanji: "年賀状", reading: "ねんがじょう", korean: "넨가죠-", meaning: "연하장",
    example: "年賀状を書きました。", exampleReading: "ねんがじょうをかきました。", exampleKorean: "넨가죠-오 카키마시타", exampleMeaning: "연하장을 썼습니다.",
    breakdown: [
      { word: "書きました", reading: "かきました", meaning: "썼습니다" }
    ] },
  { level: "N5", kanji: "お歳暮", reading: "おせいぼ", korean: "오세-보", meaning: "연말 선물",
    example: "お世話になった人にお歳暮を贈りました。", exampleReading: "おせわになったひとにおせいぼをおくりました。", exampleKorean: "오세와니 낫타 히토니 오세-보오 오쿠리마시타", exampleMeaning: "신세 진 분께 연말 선물을 보냈습니다.",
    breakdown: [
      { word: "お世話になった", reading: "おせわになった", meaning: "신세 진" }
    ] },
  { level: "N5", kanji: "お中元", reading: "おちゅうげん", korean: "오츄-겐", meaning: "여름 선물",
    example: "お中元を送りました。", exampleReading: "おちゅうげんをおくりました。", exampleKorean: "오츄-겡오 오쿠리마시타", exampleMeaning: "여름 선물을 보냈습니다.",
    breakdown: [
      { word: "送りました", reading: "おくりました", meaning: "보냈습니다" }
    ] },
  { level: "N5", kanji: "記念写真", reading: "きねんしゃしん", korean: "키넨샤신", meaning: "기념사진",
    example: "記念写真を撮りました。", exampleReading: "きねんしゃしんをとりました。", exampleKorean: "키넨샤신오 토리마시타", exampleMeaning: "기념사진을 찍었습니다.",
    breakdown: [
      { word: "撮りました", reading: "とりました", meaning: "찍었습니다" }
    ] },
  { level: "N5", kanji: "家族旅行", reading: "かぞくりょこう", korean: "카조쿠료코-", meaning: "가족여행",
    example: "夏に家族旅行に行きました。", exampleReading: "なつにかぞくりょこうにいきました。", exampleKorean: "나츠니 카조쿠료코-니 이키마시타", exampleMeaning: "여름에 가족여행을 갔습니다.",
    breakdown: [
      { word: "夏", reading: "なつ", meaning: "여름" }
    ] },
  ...
  { level: "N4", kanji: "血液型", reading: "けつえきがた", korean: "케츠에키가타", meaning: "혈액형",
    example: "私の血液型はA型です。", exampleReading: "わたしのけつえきがたはエーがたです。", exampleKorean: "와타시노 케츠에키가타와 에-가타데스", exampleMeaning: "제 혈액형은 A형입니다.",
    breakdown: [
      { word: "A型", reading: "エーがた", meaning: "A형" }
    ] },
  { level: "N4", kanji: "花粉症", reading: "かふんしょう", korean: "카훈쇼-", meaning: "꽃가루 알레르기",
    example: "春は花粉症がひどいです。", exampleReading: "はるはかふんしょうがひどいです。", exampleKorean: "하루와 카훈쇼-가 히도이데스", exampleMeaning: "봄에는 꽃가루 알레르기가 심합니다.",
    breakdown: [
      { word: "春", reading: "はる", meaning: "봄" }
    ] },
  { level: "N4", kanji: "アレルギー", reading: "アレルギー", korean: "아레루기-", meaning: "알레르기",
    example: "卵アレルギーがあります。", exampleReading: "たまごアレルギーがあります。", exampleKorean: "타마고 아레루기-가 아리마스", exampleMeaning: "계란 알레르기가 있습니다.",
    breakdown: [
      { word: "卵", reading: "たまご", meaning: "계란" }
    ] },
  { level: "N4", kanji: "貧血", reading: "ひんけつ", korean: "힌케츠", meaning: "빈혈",
    example: "貧血で倒れました。", exampleReading: "ひんけつでたおれました。", exampleKorean: "힌케츠데 타오레마시타", exampleMeaning: "빈혈로 쓰러졌습니다.",
    breakdown: [
      { word: "倒れました", reading: "たおれました", meaning: "쓰러졌습니다" }
    ] },
  { level: "N4", kanji: "食欲", reading: "しょくよく", korean: "쇼쿠요쿠", meaning: "식욕",
    example: "最近食欲がありません。", exampleReading: "さいきんしょくよくがありません。", exampleKorean: "사이킨 쇼쿠요쿠가 아리마셍", exampleMeaning: "요즘 식욕이 없습니다.",
    breakdown: [
      { word: "最近", reading: "さいきん", meaning: "요즘" }
    ] },
  { level: "N4", kanji: "便秘", reading: "べんぴ", korean: "벤피", meaning: "변비",
    example: "便秘に悩んでいます。", exampleReading: "べんぴになやんでいます。", exampleKorean: "벤피니 나얀데 이마스", exampleMeaning: "변비로 고민하고 있습니다.",
    breakdown: [
      { word: "悩んで", reading: "なやんで", meaning: "고민해서" }
    ] },
  { level: "N4", kanji: "下痢", reading: "げり", korean: "게리", meaning: "설사",
    example: "昨日から下痢が続いています。", exampleReading: "きのうからげりがつづいています。", exampleKorean: "키노-카라 게리가 츠즈이테 이마스", exampleMeaning: "어제부터 설사가 계속되고 있습니다.",
    breakdown: [
      { word: "昨日から", reading: "きのうから", meaning: "어제부터" }
    ] },
  { level: "N4", kanji: "吐き気", reading: "はきけ", korean: "하키케", meaning: "구역질, 메스꺼움",
    example: "吐き気がします。", exampleReading: "はきけがします。", exampleKorean: "하키케가 시마스", exampleMeaning: "구역질이 납니다.",
    breakdown: [
      { word: "します", reading: "します", meaning: "납니다" }
    ] },
  { level: "N4", kanji: "めまい", reading: "めまい", korean: "메마이", meaning: "현기증",
    example: "急にめまいがしました。", exampleReading: "きゅうにめまいがしました。", exampleKorean: "큐-니 메마이가 시마시타", exampleMeaning: "갑자기 현기증이 났습니다.",
    breakdown: [
      { word: "急に", reading: "きゅうに", meaning: "갑자기" }
    ] },
  { level: "N4", kanji: "肩こり", reading: "かたこり", korean: "카타코리", meaning: "어깨 결림",
    example: "デスクワークで肩こりがひどいです。", exampleReading: "デスクワークでかたこりがひどいです。", exampleKorean: "데스쿠와-쿠데 카타코리가 히도이데스", exampleMeaning: "사무직 일로 어깨 결림이 심합니다.",
    breakdown: [
      { word: "デスクワーク", reading: "デスクワーク", meaning: "사무직 일" }
    ] },
  { level: "N4", kanji: "腰痛", reading: "ようつう", korean: "요-츠-", meaning: "요통",
    example: "腰痛で病院に行きました。", exampleReading: "ようつうでびょういんにいきました。", exampleKorean: "요-츠-데 뵤-인니 이키마시타", exampleMeaning: "요통으로 병원에 갔습니다.",
    breakdown: [
      { word: "病院", reading: "びょういん", meaning: "병원" }
    ] },
  { level: "N4", kanji: "頭痛", reading: "ずつう", korean: "즈츠-", meaning: "두통",
    example: "頭痛がひどくて薬を飲みました。", exampleReading: "ずつうがひどくてくすりをのみました。", exampleKorean: "즈츠-가 히도쿠테 쿠스리오 노미마시타", exampleMeaning: "두통이 심해서 약을 먹었습니다.",
    breakdown: [
      { word: "薬", reading: "くすり", meaning: "약" }
    ] },
  { level: "N4", kanji: "歯医者", reading: "はいしゃ", korean: "하이샤", meaning: "치과",
    example: "歯医者で虫歯を治しました。", exampleReading: "はいしゃでむしばをなおしました。", exampleKorean: "하이샤데 무시바오 나오시마시타", exampleMeaning: "치과에서 충치를 치료했습니다.",
    breakdown: [
      { word: "虫歯", reading: "むしば", meaning: "충치" }
    ] },
  { level: "N4", kanji: "虫歯", reading: "むしば", korean: "무시바", meaning: "충치",
    example: "虫歯ができてしまいました。", exampleReading: "むしばができてしまいました。", exampleKorean: "무시바가 데키테 시마이마시타", exampleMeaning: "충치가 생겨버렸습니다.",
    breakdown: [
      { word: "できて", reading: "できて", meaning: "생겨서" }
    ] },
  { level: "N4", kanji: "抜歯", reading: "ばっし", korean: "밧시", meaning: "발치",
    example: "親知らずを抜歯しました。", exampleReading: "おやしらずをばっししました。", exampleKorean: "오야시라즈오 밧시 시마시타", exampleMeaning: "사랑니를 발치했습니다.",
    breakdown: [
      { word: "親知らず", reading: "おやしらず", meaning: "사랑니" }
    ] },
  { level: "N4", kanji: "治療費", reading: "ちりょうひ", korean: "치료-히", meaning: "치료비",
    example: "治療費が高かったです。", exampleReading: "ちりょうひがたかかったです。", exampleKorean: "치료-히가 타카캇타데스", exampleMeaning: "치료비가 비쌌습니다.",
    breakdown: [
      { word: "高かった", reading: "たかかった", meaning: "비쌌다" }
    ] },
  { level: "N4", kanji: "入れ歯", reading: "いれば", korean: "이레바", meaning: "틀니",
    example: "祖父は入れ歯を使っています。", exampleReading: "そふはいればをつかっています。", exampleKorean: "소후와 이레바오 츠캇테 이마스", exampleMeaning: "할아버지는 틀니를 사용하고 있습니다.",
    breakdown: [
      { word: "祖父", reading: "そふ", meaning: "할아버지" }
    ] },
  { level: "N4", kanji: "矯正", reading: "きょうせい", korean: "쿄-세-", meaning: "교정",
    example: "歯の矯正をしています。", exampleReading: "はのきょうせいをしています。", exampleKorean: "하노 쿄-세-오 시테 이마스", exampleMeaning: "치아 교정을 하고 있습니다.",
    breakdown: [
      { word: "歯", reading: "は", meaning: "치아" }
    ] },
  { level: "N4", kanji: "視力", reading: "しりょく", korean: "시료쿠", meaning: "시력",
    example: "視力が下がりました。", exampleReading: "しりょくがさがりました。", exampleKorean: "시료쿠가 사가리마시타", exampleMeaning: "시력이 떨어졌습니다.",
    breakdown: [
      { word: "下がりました", reading: "さがりました", meaning: "떨어졸습니다" }
    ] },
  { level: "N4", kanji: "聴力", reading: "ちょうりょく", korean: "쵸-료쿠", meaning: "청력",
    example: "聴力を検査しました。", exampleReading: "ちょうりょくをけんさしました。", exampleKorean: "쵸-료쿠오 켄사 시마시타", exampleMeaning: "청력을 검사했습니다.",
    breakdown: [
      { word: "検査", reading: "けんさ", meaning: "검사" }
    ] },
  { level: "N4", kanji: "老眼", reading: "ろうがん", korean: "로-간", meaning: "노안",
    example: "最近老眼になってきました。", exampleReading: "さいきんろうがんになってきました。", exampleKorean: "사이킨 로-간니 낫테 키마시타", exampleMeaning: "요즘 노안이 되었습니다.",
    breakdown: [
      { word: "最近", reading: "さいきん", meaning: "요즘" }
    ] },
  { level: "N4", kanji: "近視", reading: "きんし", korean: "킨시", meaning: "근시",
    example: "近視でめがねをかけています。", exampleReading: "きんしでめがねをかけています。", exampleKorean: "킨시데 메가네오 카케테 이마스", exampleMeaning: "근시라서 안경을 쓰고 있습니다.",
    breakdown: [
      { word: "めがね", reading: "めがね", meaning: "안경" }
    ] },
  { level: "N4", kanji: "遠視", reading: "えんし", korean: "엔시", meaning: "원시",
    example: "子供が遠視だと言われました。", exampleReading: "こどもがえんしだといわれました。", exampleKorean: "코도모가 엔시다토 이와레마시타", exampleMeaning: "아이가 원시라고 들었습니다.",
    breakdown: [
      { word: "子供", reading: "こども", meaning: "아이" }
    ] },
  { level: "N4", kanji: "乱視", reading: "らんし", korean: "란시", meaning: "난시",
    example: "乱視もあるようです。", exampleReading: "らんしもあるようです。", exampleKorean: "란시모 아루요-데스", exampleMeaning: "난시도 있는 것 같습니다.",
    breakdown: [
      { word: "ようです", reading: "ようです", meaning: "것 같습니다" }
    ] },
  { level: "N4", kanji: "コンタクト", reading: "コンタクト", korean: "콘타쿠토", meaning: "콘택트렌즈",
    example: "コンタクトをつけています。", exampleReading: "コンタクトをつけています。", exampleKorean: "콘타쿠토오 츠케테 이마스", exampleMeaning: "콘택트렌즈를 착용하고 있습니다.",
    breakdown: [
      { word: "つけて", reading: "つけて", meaning: "착용해서" }
    ] },
  { level: "N4", kanji: "点滴", reading: "てんてき", korean: "텐테키", meaning: "링거",
    example: "病院で点滴を受けました。", exampleReading: "びょういんでてんてきをうけました。", exampleKorean: "뵤-인데 텐테키오 우케마시타", exampleMeaning: "병원에서 링거를 맞았습니다.",
    breakdown: [
      { word: "病院", reading: "びょういん", meaning: "병원" }
    ] },
  { level: "N4", kanji: "注射", reading: "ちゅうしゃ", korean: "츄-샤", meaning: "주사",
    example: "注射を打ちました。", exampleReading: "ちゅうしゃをうちました。", exampleKorean: "츄-샤오 우치마시타", exampleMeaning: "주사를 맞았습니다.",
    breakdown: [
      { word: "打ちました", reading: "うちました", meaning: "맞았습니다" }
    ] },
  { level: "N4", kanji: "麻酔", reading: "ますい", korean: "마스이", meaning: "마취",
    example: "麻酔をかけて手術しました。", exampleReading: "ますいをかけてしゅじゅつしました。", exampleKorean: "마스이오 카케테 슈쥬츠 시마시타", exampleMeaning: "마취를 하고 수술했습니다.",
    breakdown: [
      { word: "手術", reading: "しゅじゅつ", meaning: "수술" }
    ] },
  { level: "N4", kanji: "手術室", reading: "しゅじゅつしつ", korean: "슈쥬츠시츠", meaning: "수술실",
    example: "手術室に運ばれました。", exampleReading: "しゅじゅつしつにはこばれました。", exampleKorean: "슈쥬츠시츠니 하코바레마시타", exampleMeaning: "수술실로 옮겨졌습니다.",
    breakdown: [
      { word: "運ばれました", reading: "はこばれました", meaning: "옮겨졌습니다" }
    ] },
  { level: "N4", kanji: "診察券", reading: "しんさつけん", korean: "신사츠켄", meaning: "진찰권",
    example: "診察券を出してください。", exampleReading: "しんさつけんをだしてください。", exampleKorean: "신사츠켕오 다시테 쿠다사이", exampleMeaning: "진찰권을 제출해 주세요.",
    breakdown: [
      { word: "出して", reading: "だして", meaning: "제출해서" }
    ] },
  { level: "N4", kanji: "賃貸", reading: "ちんたい", korean: "친타이", meaning: "임대",
    example: "賃貸のマンションに住んでいます。", exampleReading: "ちんたいのマンションにすんでいます。", exampleKorean: "친타이노 만숀니 슨데 이마스", exampleMeaning: "임대 아파트에 살고 있습니다.",
    breakdown: [
      { word: "マンション", reading: "マンション", meaning: "아파트" }
    ] },
  { level: "N4", kanji: "分譲", reading: "ぶんじょう", korean: "분죠-", meaning: "분양",
    example: "分譲マンションを買いました。", exampleReading: "ぶんじょうマンションをかいました。", exampleKorean: "분죠- 만숀오 카이마시타", exampleMeaning: "분양 아파트를 샀습니다.",
    breakdown: [
      { word: "マンション", reading: "マンション", meaning: "아파트" }
    ] },
  { level: "N4", kanji: "敷金", reading: "しききん", korean: "시키킨", meaning: "보증금",
    example: "敷金を払いました。", exampleReading: "しききんをはらいました。", exampleKorean: "시키킹오 하라이마시타", exampleMeaning: "보증금을 냈습니다.",
    breakdown: [
      { word: "払いました", reading: "はらいました", meaning: "냈습니다" }
    ] },
  { level: "N4", kanji: "礼金", reading: "れいきん", korean: "레-킨", meaning: "사례금",
    example: "礼金は不要でした。", exampleReading: "れいきんはふようでした。", exampleKorean: "레-킹와 후요-데시타", exampleMeaning: "사례금은 불필요했습니다.",
    breakdown: [
      { word: "不要", reading: "ふよう", meaning: "불필요" }
    ] },
  { level: "N4", kanji: "仲介手数料", reading: "ちゅうかいてすうりょう", korean: "츄-카이테스-료-", meaning: "중개수수료",
    example: "仲介手数料がかかりました。", exampleReading: "ちゅうかいてすうりょうがかかりました。", exampleKorean: "츄-카이테스-료-가 카카리마시타", exampleMeaning: "중개수수료가 들었습니다.",
    breakdown: [
      { word: "かかりました", reading: "かかりました", meaning: "들었습니다" }
    ] },
  { level: "N4", kanji: "不動産屋", reading: "ふどうさんや", korean: "후도-산야", meaning: "부동산 중개소",
    example: "不動産屋で部屋を探しました。", exampleReading: "ふどうさんやでへやをさがしました。", exampleKorean: "후도-산야데 헤야오 사가시마시타", exampleMeaning: "부동산에서 방을 찾았습니다.",
    breakdown: [
      { word: "部屋", reading: "へや", meaning: "방" }
    ] },
  { level: "N4", kanji: "間取り", reading: "まどり", korean: "마도리", meaning: "방 구조, 평면도",
    example: "この部屋の間取りが気に入りました。", exampleReading: "このへやのまどりがきにいりました。", exampleKorean: "코노 헤야노 마도리가 키니이리마시타", exampleMeaning: "이 방의 구조가 마음에 들었습니다.",
    breakdown: [
      { word: "気に入りました", reading: "きにいりました", meaning: "마음에 들었습니다" }
    ] },
  { level: "N4", kanji: "築年数", reading: "ちくねんすう", korean: "치쿠넨스-", meaning: "건축연수",
    example: "築年数が古い物件です。", exampleReading: "ちくねんすうがふるいぶっけんです。", exampleKorean: "치쿠넨스-가 후루이 붓켄데스", exampleMeaning: "건축연수가 오래된 매물입니다.",
    breakdown: [
      { word: "物件", reading: "ぶっけん", meaning: "매물" }
    ] },
  { level: "N4", kanji: "賃料", reading: "ちんりょう", korean: "친료-", meaning: "임대료",
    example: "賃料が上がりました。", exampleReading: "ちんりょうがあがりました。", exampleKorean: "친료-가 아가리마시타", exampleMeaning: "임대료가 올랐습니다.",
    breakdown: [
      { word: "上がりました", reading: "あがりました", meaning: "올랐습니다" }
    ] },
  { level: "N4", kanji: "更新料", reading: "こうしんりょう", korean: "코-신료-", meaning: "갱신료",
    example: "契約の更新料を払いました。", exampleReading: "けいやくのこうしんりょうをはらいました。", exampleKorean: "케-야쿠노 코-신료-오 하라이마시타", exampleMeaning: "계약 갱신료를 냈습니다.",
    breakdown: [
      { word: "契約", reading: "けいやく", meaning: "계약" }
    ] },
  { level: "N4", kanji: "退去", reading: "たいきょ", korean: "타이쿄", meaning: "퇴거",
    example: "来月退去する予定です。", exampleReading: "らいげつたいきょするよていです。", exampleKorean: "라이게츠 타이쿄스루 요테-데스", exampleMeaning: "다음 달에 퇴거할 예정입니다.",
    breakdown: [
      { word: "来月", reading: "らいげつ", meaning: "다음 달" }
    ] },
  { level: "N4", kanji: "入居", reading: "にゅうきょ", korean: "뉴-쿄", meaning: "입주",
    example: "来週入居します。", exampleReading: "らいしゅうにゅうきょします。", exampleKorean: "라이슈- 뉴-쿄 시마스", exampleMeaning: "다음 주에 입주합니다.",
    breakdown: [
      { word: "来週", reading: "らいしゅう", meaning: "다음 주" }
    ] },
  { level: "N4", kanji: "管理費", reading: "かんりひ", korean: "칸리히", meaning: "관리비",
    example: "毎月管理費を払います。", exampleReading: "まいつきかんりひをはらいます。", exampleKorean: "마이츠키 칸리히오 하라이마스", exampleMeaning: "매달 관리비를 냅니다.",
    breakdown: [
      { word: "毎月", reading: "まいつき", meaning: "매달" }
    ] },
  { level: "N4", kanji: "修繕", reading: "しゅうぜん", korean: "슈-젠", meaning: "수선",
    example: "屋根を修繕しました。", exampleReading: "やねをしゅうぜんしました。", exampleKorean: "야네오 슈-젠 시마시타", exampleMeaning: "지붕을 수선했습니다.",
    breakdown: [
      { word: "屋根", reading: "やね", meaning: "지붕" }
    ] },
  { level: "N4", kanji: "大家", reading: "おおや", korean: "오-야", meaning: "집주인",
    example: "大家さんに家賃を払いました。", exampleReading: "おおやさんにやちんをはらいました。", exampleKorean: "오-야산니 야칭오 하라이마시타", exampleMeaning: "집주인에게 집세를 냈습니다.",
    breakdown: [
      { word: "家賃", reading: "やちん", meaning: "집세" }
    ] },
  { level: "N4", kanji: "契約更新", reading: "けいやくこうしん", korean: "케-야쿠코-신", meaning: "계약갱신",
    example: "契約更新の時期です。", exampleReading: "けいやくこうしんのじきです。", exampleKorean: "케-야쿠코-신노 지키데스", exampleMeaning: "계약갱신 시기입니다.",
    breakdown: [
      { word: "時期", reading: "じき", meaning: "시기" }
    ] },
  { level: "N4", kanji: "保証人", reading: "ほしょうにん", korean: "호쇼-닌", meaning: "보증인",
    example: "保証人が必要です。", exampleReading: "ほしょうにんがひつようです。", exampleKorean: "호쇼-닌가 히츠요-데스", exampleMeaning: "보증인이 필요합니다.",
    breakdown: [
      { word: "必要", reading: "ひつよう", meaning: "필요" }
    ] },
  { level: "N4", kanji: "火災保険", reading: "かさいほけん", korean: "카사이호켄", meaning: "화재보험",
    example: "火災保険に入りました。", exampleReading: "かさいほけんにはいりました。", exampleKorean: "카사이 호켄니 하이리마시타", exampleMeaning: "화재보험에 가입했습니다.",
    breakdown: [
      { word: "入りました", reading: "はいりました", meaning: "가입했습니다" }
    ] },
  { level: "N4", kanji: "近隣", reading: "きんりん", korean: "킨린", meaning: "근린, 이웃",
    example: "近隣の住民と仲良くしています。", exampleReading: "きんりんのじゅうみんとなかよくしています。", exampleKorean: "킨린노 쥬-민토 나카요쿠 시테 이마스", exampleMeaning: "이웃 주민과 사이좋게 지내고 있습니다.",
    breakdown: [
      { word: "住民", reading: "じゅうみん", meaning: "주민" }
    ] },
  { level: "N4", kanji: "立地", reading: "りっち", korean: "릿치", meaning: "입지",
    example: "この店は立地が良いです。", exampleReading: "このみせはりっちがいいです。", exampleKorean: "코노 미세와 릿치가 이-데스", exampleMeaning: "이 가게는 입지가 좋습니다.",
    breakdown: [
      { word: "店", reading: "みせ", meaning: "가게" }
    ] },
  ...
  { level: "N1", kanji: "謙譲", reading: "けんじょう", korean: "켄죠-", meaning: "겸양",
    example: "謙譲の精神を大切にしています。", exampleReading: "けんじょうのせいしんをたいせつにしています。", exampleKorean: "켄죠-노 세-싱오 타이세츠니 시테 이마스", exampleMeaning: "겸양의 정신을 소중히 하고 있습니다.",
    breakdown: [
      { word: "精神", reading: "せいしん", meaning: "정신" }
    ] },
  { level: "N1", kanji: "敬語", reading: "けいご", korean: "케-고", meaning: "존댓말",
    example: "敬語を正しく使うのは難しいです。", exampleReading: "けいごをただしくつかうのはむずかしいです。", exampleKorean: "케-고오 타다시쿠 츠카우노와 무즈카시-데스", exampleMeaning: "존댓말을 정확히 쓰는 것은 어렵습니다.",
    breakdown: [
      { word: "正しく", reading: "ただしく", meaning: "정확히" }
    ] },
  { level: "N1", kanji: "丁重", reading: "ていちょう", korean: "테-쵸-", meaning: "정중",
    example: "お客様を丁重にもてなしました。", exampleReading: "おきゃくさまをていちょうにもてなしました。", exampleKorean: "오캬쿠사마오 테-쵸-니 모테나시마시타", exampleMeaning: "손님을 정중하게 대접했습니다.",
    breakdown: [
      { word: "お客様", reading: "おきゃくさま", meaning: "손님" }
    ] },
  { level: "N1", kanji: "無礼", reading: "ぶれい", korean: "부레-", meaning: "무례",
    example: "無礼な態度に驚きました。", exampleReading: "ぶれいなたいどにおどろきました。", exampleKorean: "부레-나 타이도니 오도로키마시타", exampleMeaning: "무례한 태도에 놀랐습니다.",
    breakdown: [
      { word: "態度", reading: "たいど", meaning: "태도" }
    ] },
  { level: "N1", kanji: "失礼", reading: "しつれい", korean: "시츠레-", meaning: "실례",
    example: "失礼なことを言ってしまいました。", exampleReading: "しつれいなことをいってしまいました。", exampleKorean: "시츠레-나 코토오 잇테 시마이마시타", exampleMeaning: "실례되는 말을 해버렸습니다.",
    breakdown: [
      { word: "言って", reading: "いって", meaning: "말해서" }
    ] },
  { level: "N1", kanji: "慎み", reading: "つつしみ", korean: "츠츠시미", meaning: "조심스러움, 신중함",
    example: "慎みのある態度が評価されました。", exampleReading: "つつしみのあるたいどがひょうかされました。", exampleKorean: "츠츠시미노 아루 타이도가 효-카사레마시타", exampleMeaning: "신중한 태도가 평가받았습니다.",
    breakdown: [
      { word: "態度", reading: "たいど", meaning: "태도" }
    ] },
  { level: "N1", kanji: "奥ゆかしい", reading: "おくゆかしい", korean: "오쿠유카시-", meaning: "그윽하다, 우아하다",
    example: "彼女は奥ゆかしい人です。", exampleReading: "かのじょはおくゆかしいひとです。", exampleKorean: "카노죠와 오쿠유카시- 히토데스", exampleMeaning: "그녀는 우아한 사람입니다.",
    breakdown: [
      { word: "彼女", reading: "かのじょ", meaning: "그녀" }
    ] },
  { level: "N1", kanji: "品格", reading: "ひんかく", korean: "힌카쿠", meaning: "품격",
    example: "彼女には品格があります。", exampleReading: "かのじょにはひんかくがあります。", exampleKorean: "카노죠니와 힌카쿠가 아리마스", exampleMeaning: "그녀에게는 품격이 있습니다.",
    breakdown: [
      { word: "彼女", reading: "かのじょ", meaning: "그녀" }
    ] },
  { level: "N1", kanji: "品位", reading: "ひんい", korean: "힌이", meaning: "품위",
    example: "品位を保つよう心がけています。", exampleReading: "ひんいをたもつようこころがけています。", exampleKorean: "힌이오 타모츠요- 코코로가케테 이마스", exampleMeaning: "품위를 유지하도록 유념하고 있습니다.",
    breakdown: [
      { word: "保つ", reading: "たもつ", meaning: "유지하다" }
    ] },
  { level: "N1", kanji: "風格", reading: "ふうかく", korean: "후-카쿠", meaning: "풍격",
    example: "彼には風格があります。", exampleReading: "かれにはふうかくがあります。", exampleKorean: "카레니와 후-카쿠가 아리마스", exampleMeaning: "그에게는 풍격이 있습니다.",
    breakdown: [
      { word: "彼", reading: "かれ", meaning: "그" }
    ] },
  { level: "N1", kanji: "貫禄", reading: "かんろく", korean: "칸로쿠", meaning: "관록",
    example: "社長としての貫禄が出てきました。", exampleReading: "しゃちょうとしてのかんろくがでてきました。", exampleKorean: "샤쵸-토시테노 칸로쿠가 데테 키마시타", exampleMeaning: "사장으로서의 관록이 생겼습니다.",
    breakdown: [
      { word: "社長", reading: "しゃちょう", meaning: "사장" }
    ] },
  { level: "N1", kanji: "威厳", reading: "いげん", korean: "이겐", meaning: "위엄",
    example: "威厳のある声で話しました。", exampleReading: "いげんのあるこえではなしました。", exampleKorean: "이겐노 아루 코에데 하나시마시타", exampleMeaning: "위엄 있는 목소리로 말했습니다.",
    breakdown: [
      { word: "声", reading: "こえ", meaning: "목소리" }
    ] },
  { level: "N1", kanji: "厳格", reading: "げんかく", korean: "겐카쿠", meaning: "엄격",
    example: "父は厳格な人でした。", exampleReading: "ちちはげんかくなひとでした。", exampleKorean: "치치와 겐카쿠나 히토데시타", exampleMeaning: "아버지는 엄격한 사람이었습니다.",
    breakdown: [
      { word: "父", reading: "ちち", meaning: "아버지" }
    ] },
  { level: "N1", kanji: "厳粛", reading: "げんしゅく", korean: "겐슈쿠", meaning: "엄숙",
    example: "厳粛な雰囲気で式が行われました。", exampleReading: "げんしゅくなふんいきでしきがおこなわれました。", exampleKorean: "겐슈쿠나 훙이키데 시키가 오코나와레마시타", exampleMeaning: "엄숙한 분위기 속에서 식이 거행되었습니다.",
    breakdown: [
      { word: "雰囲気", reading: "ふんいき", meaning: "분위기" }
    ] },
  { level: "N1", kanji: "荘厳", reading: "そうごん", korean: "소-곤", meaning: "장엄",
    example: "荘厳な建物に感動しました。", exampleReading: "そうごんなたてものにかんどうしました。", exampleKorean: "소-곤나 타테모노니 칸도- 시마시타", exampleMeaning: "장엄한 건물에 감동했습니다.",
    breakdown: [
      { word: "建物", reading: "たてもの", meaning: "건물" }
    ] },
  { level: "N1", kanji: "神妙", reading: "しんみょう", korean: "신묘-", meaning: "신묘함, 얌전함",
    example: "彼は神妙な顔をしていました。", exampleReading: "かれはしんみょうなかおをしていました。", exampleKorean: "카레와 신묘-나 카오오 시테 이마시타", exampleMeaning: "그는 얌전한 얼굴을 하고 있었습니다.",
    breakdown: [
      { word: "顔", reading: "かお", meaning: "얼굴" }
    ] },
  { level: "N1", kanji: "殊勝", reading: "しゅしょう", korean: "슈쇼-", meaning: "기특함",
    example: "殊勝な心がけですね。", exampleReading: "しゅしょうなこころがけですね。", exampleKorean: "슈쇼-나 코코로가케데스네", exampleMeaning: "기특한 마음가짐이네요.",
    breakdown: [
      { word: "心がけ", reading: "こころがけ", meaning: "마음가짐" }
    ] },
  { level: "N1", kanji: "健気", reading: "けなげ", korean: "케나게", meaning: "기특함, 씩씩함",
    example: "子供が健気に頑張っています。", exampleReading: "こどもがけなげにがんばっています。", exampleKorean: "코도모가 케나게니 감밧테 이마스", exampleMeaning: "아이가 씩씩하게 노력하고 있습니다.",
    breakdown: [
      { word: "頑張って", reading: "がんばって", meaning: "노력해서" }
    ] },
  { level: "N1", kanji: "いじらしい", reading: "いじらしい", korean: "이지라시-", meaning: "애처롭다, 갸륵하다",
    example: "子供の姿がいじらしいです。", exampleReading: "こどものすがたがいじらしいです。", exampleKorean: "코도모노 스가타가 이지라시-데스", exampleMeaning: "아이의 모습이 애처롭습니다.",
    breakdown: [
      { word: "姿", reading: "すがた", meaning: "모습" }
    ] },
  { level: "N1", kanji: "痛々しい", reading: "いたいたしい", korean: "이타이타시-", meaning: "애처롭다, 안타깝다",
    example: "痛々しい姿を見て涙が出ました。", exampleReading: "いたいたしいすがたをみてなみだがでました。", exampleKorean: "이타이타시- 스가타오 미테 나미다가 데마시타", exampleMeaning: "안타까운 모습을 보고 눈물이 났습니다.",
    breakdown: [
      { word: "涙", reading: "なみだ", meaning: "눈물" }
    ] },
  { level: "N1", kanji: "切ない", reading: "せつない", korean: "세츠나이", meaning: "애달프다, 안타깝다",
    example: "別れが切ないです。", exampleReading: "わかれがせつないです。", exampleKorean: "와카레가 세츠나이데스", exampleMeaning: "이별이 애달픕니다.",
    breakdown: [
      { word: "別れ", reading: "わかれ", meaning: "이별" }
    ] },
  { level: "N1", kanji: "やるせない", reading: "やるせない", korean: "야루세나이", meaning: "처량하다, 마음이 아프다",
    example: "やるせない気持ちになりました。", exampleReading: "やるせないきもちになりました。", exampleKorean: "야루세나이 키모치니 나리마시타", exampleMeaning: "처량한 기분이 되었습니다.",
    breakdown: [
      { word: "気持ち", reading: "きもち", meaning: "기분" }
    ] },
  { level: "N1", kanji: "侘しい", reading: "わびしい", korean: "와비시-", meaning: "쓸쓸하다, 초라하다",
    example: "一人の食事は侘しいです。", exampleReading: "ひとりのしょくじはわびしいです。", exampleKorean: "히토리노 쇼쿠지와 와비시-데스", exampleMeaning: "혼자 하는 식사는 쓸쓸합니다.",
    breakdown: [
      { word: "一人", reading: "ひとり", meaning: "혼자" }
    ] },
  { level: "N1", kanji: "儚い", reading: "はかない", korean: "하카나이", meaning: "덧없다",
    example: "儚い夢を見ました。", exampleReading: "はかないゆめをみました。", exampleKorean: "하카나이 유메오 미마시타", exampleMeaning: "덧없는 꿈을 꿨습니다.",
    breakdown: [
      { word: "夢", reading: "ゆめ", meaning: "꿈" }
    ] },
  { level: "N1", kanji: "虚しい", reading: "むなしい", korean: "무나시-", meaning: "허무하다",
    example: "努力が虚しく終わりました。", exampleReading: "どりょくがむなしくおわりました。", exampleKorean: "도료쿠가 무나시쿠 오와리마시타", exampleMeaning: "노력이 허무하게 끝났습니다.",
    breakdown: [
      { word: "努力", reading: "どりょく", meaning: "노력" }
    ] },
  { level: "N1", kanji: "名残惜しい", reading: "なごりおしい", korean: "나고리오시-", meaning: "아쉽다, 섭섭하다",
    example: "別れが名残惜しいです。", exampleReading: "わかれがなごりおしいです。", exampleKorean: "와카레가 나고리오시-데스", exampleMeaning: "헤어짐이 아쉽습니다.",
    breakdown: [
      { word: "別れ", reading: "わかれ", meaning: "헤어짐" }
    ] },
  { level: "N1", kanji: "物悲しい", reading: "ものがなしい", korean: "모노가나시-", meaning: "애처롭다, 구슬프다",
    example: "物悲しい音楽が流れていました。", exampleReading: "ものがなしいおんがくがながれていました。", exampleKorean: "모노가나시- 옹가쿠가 나가레테 이마시타", exampleMeaning: "구슬픈 음악이 흐르고 있었습니다.",
    breakdown: [
      { word: "音楽", reading: "おんがく", meaning: "음악" }
    ] },
  { level: "N1", kanji: "悲哀", reading: "ひあい", korean: "히아이", meaning: "비애",
    example: "人生の悲哀を感じました。", exampleReading: "じんせいのひあいをかんじました。", exampleKorean: "진세-노 히아이오 칸지마시타", exampleMeaning: "인생의 비애를 느꼈습니다.",
    breakdown: [
      { word: "人生", reading: "じんせい", meaning: "인생" }
    ] },
  { level: "N1", kanji: "哀愁", reading: "あいしゅう", korean: "아이슈-", meaning: "애수",
    example: "哀愁を帯びたメロディーです。", exampleReading: "あいしゅうをおびたメロディーです。", exampleKorean: "아이슈-오 오비타 메로디-데스", exampleMeaning: "애수를 띤 멜로디입니다.",
    breakdown: [
      { word: "メロディー", reading: "メロディー", meaning: "멜로디" }
    ] },
  { level: "N1", kanji: "情緒", reading: "じょうちょ", korean: "죠-쵸", meaning: "정서",
    example: "情緒不安定になっています。", exampleReading: "じょうちょふあんていになっています。", exampleKorean: "죠-쵸 후안테-니 낫테 이마스", exampleMeaning: "정서 불안정 상태가 되었습니다.",
    breakdown: [
  ...
  { level: "N1", kanji: "忌憚", reading: "きたん", korean: "키탄", meaning: "기탄, 거리낌",
    example: "忌憚のない意見をお願いします。", exampleReading: "きたんのないいけんをおねがいします。", exampleKorean: "키탄노 나이 이켕오 오네가이 시마스", exampleMeaning: "기탄없는 의견을 부탁드립니다.",
    breakdown: [
      { word: "意見", reading: "いけん", meaning: "의견" }
    ] },
  { level: "N1", kanji: "忌み嫌う", reading: "いみきらう", korean: "이미키라우", meaning: "몹시 싫어하다",
    example: "彼らはその話題を忌み嫌っています。", exampleReading: "かれらはそのわだいをいみきらっています。", exampleKorean: "카레라와 소노 와다이오 이미키랏테 이마스", exampleMeaning: "그들은 그 화제를 몹시 싫어합니다.",
    breakdown: [
      { word: "話題", reading: "わだい", meaning: "화제" }
    ] },
  { level: "N1", kanji: "疎ましい", reading: "うとましい", korean: "우토마시-", meaning: "꺼려지다, 싫다",
    example: "その態度が疎ましく感じられました。", exampleReading: "そのたいどがうとましくかんじられました。", exampleKorean: "소노 타이도가 우토마시쿠 칸지라레마시타", exampleMeaning: "그 태도가 꺼려지게 느껴졌습니다.",
    breakdown: [
      { word: "態度", reading: "たいど", meaning: "태도" }
    ] },
  { level: "N1", kanji: "煙たい", reading: "けむたい", korean: "케무타이", meaning: "(연기가) 맵다, 거북하다",
    example: "上司の前だと煙たいです。", exampleReading: "じょうしのまえだとけむたいです。", exampleKorean: "죠-시노 마에다토 케무타이데스", exampleMeaning: "상사 앞에서는 거북합니다.",
    breakdown: [
      { word: "上司", reading: "じょうし", meaning: "상사" }
    ] },
  { level: "N1", kanji: "疎む", reading: "うとむ", korean: "우토무", meaning: "멀리하다, 소원히 여기다",
    example: "彼は周囲から疎まれています。", exampleReading: "かれはしゅういからうとまれています。", exampleKorean: "카레와 슈-이카라 우토마레테 이마스", exampleMeaning: "그는 주위로부터 소외당하고 있습니다.",
    breakdown: [
      { word: "周囲", reading: "しゅうい", meaning: "주위" }
    ] },
  { level: "N1", kanji: "うとい", reading: "うとい", korean: "우토이", meaning: "어둡다, 서투르다(사정에)",
    example: "彼は経済にうといです。", exampleReading: "かれはけいざいにうといです。", exampleKorean: "카레와 케-자이니 우토이데스", exampleMeaning: "그는 경제에 어둡습니다.",
    breakdown: [
      { word: "経済", reading: "けいざい", meaning: "경제" }
    ] },
  { level: "N1", kanji: "億劫", reading: "おっくう", korean: "옥쿠-", meaning: "귀찮음",
    example: "外出するのが億劫です。", exampleReading: "がいしゅつするのがおっくうです。", exampleKorean: "가이슈츠스루노가 옥쿠-데스", exampleMeaning: "외출하는 것이 귀찮습니다.",
    breakdown: [
      { word: "外出", reading: "がいしゅつ", meaning: "외출" }
    ] },
  { level: "N1", kanji: "うんざり", reading: "うんざり", korean: "운자리", meaning: "진저리, 지긋지긋함",
    example: "同じ話にうんざりしています。", exampleReading: "おなじはなしにうんざりしています。", exampleKorean: "오나지 하나시니 운자리 시테 이마스", exampleMeaning: "같은 이야기에 지긋지긋합니다.",
    breakdown: [
      { word: "話", reading: "はなし", meaning: "이야기" }
    ] },
  { level: "N1", kanji: "辟易", reading: "へきえき", korean: "헤키에키", meaning: "질림, 진저리남",
    example: "彼の自慢話に辟易しました。", exampleReading: "かれのじまんばなしにへきえきしました。", exampleKorean: "카레노 지만바나시니 헤키에키 시마시타", exampleMeaning: "그의 자랑에 질렸습니다.",
    breakdown: [
      { word: "自慢話", reading: "じまんばなし", meaning: "자랑" }
    ] },
  { level: "N1", kanji: "食傷", reading: "しょくしょう", korean: "쇼쿠쇼-", meaning: "식상함",
    example: "同じパターンに食傷気味です。", exampleReading: "おなじパターンにしょくしょうぎみです。", exampleKorean: "오나지 파타-은니 쇼쿠쇼-기미데스", exampleMeaning: "같은 패턴에 식상한 느낌입니다.",
    breakdown: [
      { word: "パターン", reading: "パターン", meaning: "패턴" }
    ] },
  { level: "N1", kanji: "閉口", reading: "へいこう", korean: "헤-코-", meaning: "질림, 손듦",
    example: "彼のわがままに閉口しました。", exampleReading: "かれのわがままにへいこうしました。", exampleKorean: "카레노 와가마마니 헤-코- 시마시타", exampleMeaning: "그의 제멋대로인 행동에 질렸습니다.",
    breakdown: [
      { word: "わがまま", reading: "わがまま", meaning: "제멋대로" }
    ] },
  { level: "N1", kanji: "手を焼く", reading: "てをやく", korean: "테오야쿠", meaning: "애를 먹다",
    example: "子供のいたずらに手を焼いています。", exampleReading: "こどものいたずらにてをやいています。", exampleKorean: "코도모노 이타즈라니 테오 야이테 이마스", exampleMeaning: "아이의 장난에 애를 먹고 있습니다.",
    breakdown: [
      { word: "いたずら", reading: "いたずら", meaning: "장난" }
    ] },
  { level: "N1", kanji: "手こずる", reading: "てこずる", korean: "테코즈루", meaning: "애먹다, 쩔쩔매다",
    example: "この問題に手こずりました。", exampleReading: "このもんだいにてこずりました。", exampleKorean: "코노 몬다이니 테코즈리마시타", exampleMeaning: "이 문제에 애먹었습니다.",
    breakdown: [
      { word: "問題", reading: "もんだい", meaning: "문제" }
    ] },
  { level: "N1", kanji: "四苦八苦", reading: "しくはっく", korean: "시쿠학쿠", meaning: "사고팔고, 매우 고생함",
    example: "締め切りに四苦八苦しています。", exampleReading: "しめきりにしくはっくしています。", exampleKorean: "시메키리니 시쿠학쿠 시테 이마스", exampleMeaning: "마감에 매우 고생하고 있습니다.",
    breakdown: [
      { word: "締め切り", reading: "しめきり", meaning: "마감" }
    ] },
  { level: "N1", kanji: "悪戦苦闘", reading: "あくせんくとう", korean: "아쿠센쿠토-", meaning: "악전고투",
    example: "悪戦苦闘の末、完成しました。", exampleReading: "あくせんくとうのすえ、かんせいしました。", exampleKorean: "아쿠센쿠토-노 스에, 칸세- 시마시타", exampleMeaning: "악전고투 끝에 완성했습니다.",
    breakdown: [
      { word: "末", reading: "すえ", meaning: "끝" }
    ] },
  { level: "N1", kanji: "苦心", reading: "くしん", korean: "쿠신", meaning: "고심",
    example: "苦心して作りました。", exampleReading: "くしんしてつくりました。", exampleKorean: "쿠신시테 츠쿠리마시타", exampleMeaning: "고심해서 만들었습니다.",
    breakdown: [
      { word: "作りました", reading: "つくりました", meaning: "만들었습니다" }
    ] },
  { level: "N1", kanji: "苦慮", reading: "くりょ", korean: "쿠료", meaning: "고려, 고심",
    example: "対策に苦慮しています。", exampleReading: "たいさくにくりょしています。", exampleKorean: "타이사쿠니 쿠료 시테 이마스", exampleMeaning: "대책 마련에 고심하고 있습니다.",
    breakdown: [
      { word: "対策", reading: "たいさく", meaning: "대책" }
    ] },
  { level: "N1", kanji: "思案", reading: "しあん", korean: "시안", meaning: "궁리, 생각",
    example: "解決策を思案しています。", exampleReading: "かいけつさくをしあんしています。", exampleKorean: "카이케츠사쿠오 시안 시테 이마스", exampleMeaning: "해결책을 궁리하고 있습니다.",
    breakdown: [
      { word: "解決策", reading: "かいけつさく", meaning: "해결책" }
    ] },
  { level: "N1", kanji: "思い悩む", reading: "おもいなやむ", korean: "오모이나야무", meaning: "고민하다",
    example: "進路について思い悩んでいます。", exampleReading: "しんろについておもいなやんでいます。", exampleKorean: "신로니 츠이테 오모이나얀데 이마스", exampleMeaning: "진로에 대해 고민하고 있습니다.",
    breakdown: [
      { word: "進路", reading: "しんろ", meaning: "진로" }
    ] },
  { level: "N1", kanji: "煩悩", reading: "ぼんのう", korean: "본노-", meaning: "번뇌",
    example: "煩悩を捨てるのは難しいです。", exampleReading: "ぼんのうをすてるのはむずかしいです。", exampleKorean: "본노-오 스테루노와 무즈카시-데스", exampleMeaning: "번뇌를 버리는 것은 어렵습니다.",
    breakdown: [
      { word: "捨てる", reading: "すてる", meaning: "버리다" }
    ] },
  { level: "N1", kanji: "葛藤する", reading: "かっとうする", korean: "캇토-스루", meaning: "갈등하다",
    example: "二つの選択肢の間で葛藤しています。", exampleReading: "ふたつのせんたくしのあいだでかっとうしています。", exampleKorean: "후타츠노 센타쿠시노 아이다데 캇토- 시테 이마스", exampleMeaning: "두 선택지 사이에서 갈등하고 있습니다.",
    breakdown: [
      { word: "選択肢", reading: "せんたくし", meaning: "선택지" }
    ] },
  { level: "N1", kanji: "逡巡", reading: "しゅんじゅん", korean: "슝쥰", meaning: "준순, 주저함",
    example: "逡巡した末、決断しました。", exampleReading: "しゅんじゅんしたすえ、けつだんしました。", exampleKorean: "슝쥰시타 스에, 케츠단 시마시타", exampleMeaning: "주저한 끝에 결단했습니다.",
    breakdown: [
      { word: "決断", reading: "けつだん", meaning: "결단" }
    ] },
  { level: "N1", kanji: "躊躇", reading: "ちゅうちょ", korean: "츄-쵸", meaning: "주저",
    example: "返事を躊躇していました。", exampleReading: "へんじをちゅうちょしていました。", exampleKorean: "헨지오 츄-쵸 시테 이마시타", exampleMeaning: "답변을 주저하고 있었습니다.",
    breakdown: [
      { word: "返事", reading: "へんじ", meaning: "답변" }
    ] },
  { level: "N1", kanji: "躊躇う", reading: "ためらう", korean: "타메라우", meaning: "주저하다, 망설이다",
    example: "返事を躊躇っていました。", exampleReading: "へんじをためらっていました。", exampleKorean: "헨지오 타메랏테 이마시타", exampleMeaning: "답변을 망설이고 있었습니다.",
    breakdown: [
      { word: "返事", reading: "へんじ", meaning: "답변" }
    ] },
  { level: "N1", kanji: "二の足を踏む", reading: "にのあしをふむ", korean: "니노아시오후무", meaning: "주저하다, 망설이다",
    example: "参加するのに二の足を踏んでいます。", exampleReading: "さんかするのににのあしをふんでいます。", exampleKorean: "상카스루노니 니노아시오 훈데 이마스", exampleMeaning: "참가하는 것을 주저하고 있습니다.",
    breakdown: [
      { word: "参加", reading: "さんか", meaning: "참가" }
    ] },
  { level: "N1", kanji: "難儀", reading: "なんぎ", korean: "난기", meaning: "곤란, 어려움",
    example: "雪道の運転に難儀しました。", exampleReading: "ゆきみちのうんてんになんぎしました。", exampleKorean: "유키미치노 운텐니 난기 시마시타", exampleMeaning: "눈길 운전에 어려움을 겪었습니다.",
    breakdown: [
      { word: "雪道", reading: "ゆきみち", meaning: "눈길" }
    ] },
  { level: "N1", kanji: "手強い", reading: "てごわい", korean: "테고와이", meaning: "만만치 않다, 강적이다",
    example: "手強い相手です。", exampleReading: "てごわいあいてです。", exampleKorean: "테고와이 아이테데스", exampleMeaning: "만만치 않은 상대입니다.",
    breakdown: [
      { word: "相手", reading: "あいて", meaning: "상대" }
    ] },
  { level: "N1", kanji: "手に負えない", reading: "てにおえない", korean: "테니오에나이", meaning: "감당할 수 없다",
    example: "もう手に負えません。", exampleReading: "もうてにおえません。", exampleKorean: "모- 테니오에마셍", exampleMeaning: "더 이상 감당할 수 없습니다.",
    breakdown: [
      { word: "もう", reading: "もう", meaning: "더 이상" }
    ] },
  { level: "N1", kanji: "骨が折れる", reading: "ほねがおれる", korean: "호네가오레루", meaning: "매우 힘들다",
    example: "この作業は骨が折れます。", exampleReading: "このさぎょうはほねがおれます。", exampleKorean: "코노 사교-와 호네가 오레마스", exampleMeaning: "이 작업은 매우 힘듭니다.",
    breakdown: [
      { word: "作業", reading: "さぎょう", meaning: "작업" }
    ] },
  { level: "N1", kanji: "骨折り", reading: "ほねおり", korean: "호네오리", meaning: "수고, 노력",
    example: "骨折り損に終わりました。", exampleReading: "ほねおりぞんにおわりました。", exampleKorean: "호네오리존니 오와리마시타", exampleMeaning: "수고만 하고 헛수고로 끝났습니다.",
    breakdown: [
